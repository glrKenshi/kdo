    ...
    const items = [
        {
            ...
            content: [
                { info: "Амблиокор 01 (лечение) 10 минут", price: "500р" },
                { info: "Аппаратное лечение по комплексу «Зайчик»", price: "6500р" },
                { info: "Аппаратное лечение по комплексу «Листик»", price: "6000р" },
                { info: "Аппаратное лечение по комплексу «Пташка»", price: "9000р" },
                { info: "Аппаратное лечение по комплексу «Солнышко»", price: "7500р" },
                { info: "Аппаратное лечение по комплексу «Цветик»", price: "6000р" },
                { info: "Комплексная диагностика детского врача-офтальмолога (Жерновая Л.М.)", price: "3000р" },
